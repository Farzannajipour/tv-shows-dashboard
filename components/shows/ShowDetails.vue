<template>
  <div class="bg-surface dark:bg-surface-dark rounded-lg shadow-lg p-6 max-w-3xl mx-auto">
    <div class="flex flex-col md:flex-row gap-6">
      ...
      <div class="flex-1">
        ...
        <div class="flex items-center mb-2">
          <span class="i-heroicons-star-20-solid text-yellow-400 mr-1" />
        ...
        <div class="prose dark:prose-invert max-w-none" v-html="show.summary"></div>
      </div>
    </div>
  </div>
</template>
